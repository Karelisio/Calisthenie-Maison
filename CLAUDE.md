...
- **À chaque publication : incrémenter `APP_BUILD` ET ajouter l'entrée
  ...
  Il a existé un temps une page web publique reprenant ce journal pour les
  amis de Karelisio ; elle a été supprimée une fois le journal intégré à
  l'app, qui la rendait redondante. Ne pas la recréer sans qu'il le demande :
  pour partager l'app, le lien de la release GitHub suffit.
